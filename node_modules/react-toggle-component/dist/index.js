  ...
  _createClass(Toggle, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        _extends({}, others, { className: classes.join(" ").trim() }),
        label ? _react2.default.createElement(
          "label",
          { htmlFor: id ? id : name },
          label
        ) : null,
        _react2.default.createElement("input", { onChange: this.onToggle,
          ...
          type: "checkbox",
          value: "1" }),
        _react2.default.createElement("label", { htmlFor: id ? id : name }),
